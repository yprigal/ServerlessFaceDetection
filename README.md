...
## The Motivation
This is a serverless project build using Azure Functions by leveraging wide range of Azure Services for implementing serverless face detection solution for images, videos and live stream.
